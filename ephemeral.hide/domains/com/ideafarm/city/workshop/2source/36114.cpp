...
//SOURCE: \ideafarm.home.1\precious\domains\com\ideafarm\city\library\dictionary\3func.36114* : 3func.36114003.strikes.strikes BEGIN
#define DDNAME       "3func.36114003.strikes.strikes"
#define DDNUMB      (countT)0x36114003
#define IDFILE      (countT)0x14bc
...
/*1*/strikeS::strikeS( tinS& tinP ) :/*1*/
stqCmdFlash( tinP , sizeof( cmdFlashS ) , 0 )
{
    BOSdOnOTtEST( WHATgbo , memset( (byteT*)&sc , 0 , sizeof sc ) )
}
...
#undef DDNUMB
#undef DDNAME
//SOURCE: \ideafarm.home.1\precious\domains\com\ideafarm\city\library\dictionary\3func.36114* : 3func.36114003.strikes.strikes END
//SOURCE: \ideafarm.home.1\precious\domains\com\ideafarm\city\library\dictionary\3func.36114* : 3func.36114004.strikes.strikes BEGIN
#define DDNAME       "3func.36114004.strikes.strikes"
#define DDNUMB      (countT)0x36114004
#define IDFILE      (countT)0x14bd
...
/*1*/strikeS::strikeS( strikeS& sP ) :/*1*/
stqCmdFlash( thirdC::third_tinS_ref_IF() , sizeof( cmdFlashS ) , 0 )
{
    ZE( countT , _brcRaw ) ;
    BOSnOtIN( memcpy( (byteT*)&sc , (byteT*)&sP.sc , sizeof sc ) )
    rCacheVolatileSnap = sP.rCacheVolatileSnap ;
    stqCmdFlash = sP.stqCmdFlash ;
}
...
#undef DDNUMB
#undef DDNAME
//SOURCE: \ideafarm.home.1\precious\domains\com\ideafarm\city\library\dictionary\3func.36114* : 3func.36114004.strikes.strikes END
