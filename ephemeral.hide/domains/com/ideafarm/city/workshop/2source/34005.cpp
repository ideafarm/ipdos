...
//SOURCE: \ideafarm.home.1\precious\domains\com\ideafarm\city\library\dictionary\3func.34005* : 3func.34005001.newdelclass BEGIN
#define DDNAME       "3func.34005001.newdelclass"
#define DDNUMB      (countT)0x34005001
#define IDFILE      (countT)0x9e6
...
NEWdELcLASSb(         deviceC                       )
NEWdELcLASSb(         displayC                      )
NEWdELcLASSb(         equal_byteTstrz_C             )
NEWdELcLASSb(         equal_countT_C                )
NEWdELcLASSb(         equal_countTstrz_C            )
NEWdELcLASSbSIZED(    etherC                        )
NEWdELcLASSb(         fieldEditParamOutC            )
NEWdELcLASSb(         fileC                         )
NEWdELcLASSb(         fileOpenS                     )
NEWdELcLASSb(         grabAnnotatedS                )
NEWdELcLASSb(         grabC                         )
NEWdELcLASSb(         grabitC                       )
NEWdELcLASSb(         grabotC                       )
NEWdELcLASSb(         grabMemorySpaceC                 )
NEWdELcLASSb(         grabWantS                     )
NEWdELcLASSb(         gridS                         )
NEWdELcLASSbSIZED(    handleC                       )
NEWdELcLASSb(         homeS                         )
NEWdELcLASSb(         htmlS                         )
NEWdELcLASSb(         cloudInfoS                    )
NEWdELcLASSb(         inOutFrameC                   )
...
#undef DDNUMB
#undef DDNAME
//SOURCE: \ideafarm.home.1\precious\domains\com\ideafarm\city\library\dictionary\3func.34005* : 3func.34005001.newdelclass END
