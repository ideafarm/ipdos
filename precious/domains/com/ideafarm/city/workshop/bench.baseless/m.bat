...
wlink.exe system nt op q op map=bench.map op mangle debug all name bench.exe file *.obj library D:\ideafarm.home.1\precious\domains\com\ideafarm\city\workshop\zlib\zlib1.2.3\dll32\zlibwapi.lib
