        ...
        else if( !strcmp( postCmd , "!worker_2snips_ipdos.h" ) )
        {
            ...
            if( isStaleF( postDraft2 , "\\ideafarm.home.1\\precious\\domains\\com\\ideafarm\\city\\library\\dictionary\\1snip.*" ) )
            {
                ...
                char* ppostFrom[] =
                {
                    ...
                    "1snip.15*.psttOldC"                        ,
                    "1snip.15*.postOldC"                        ,
                    "1snip.15*.grabMemorySpaceC"                ,
                    "1snip.15*.backGrabMemorySpaceC"            ,
                    "1snip.15*.fileOpenS"                       ,
                    "1snip.15*.ranUniC"                         ,
                    ...
                    "1snip.15*.inOutFrameAuditTimeS"            ,
                    "1snip.15*.inOutFrameAuditCpuCyclesS"       ,
