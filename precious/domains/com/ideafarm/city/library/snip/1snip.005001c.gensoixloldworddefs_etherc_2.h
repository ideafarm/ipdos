...
voidT diskFindFileOrDirF_4Pb4P_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
   ...
   SOIXLoLDtESTtYPE( 0xdddd8014 , etherC )
    ...
    if( !POOP ) etherP.diskFindFileOrDirF( tinP , psttNameP , handleP , psttLikeP ) ;
...
voidT diskFindFileOrDirF_4P4PhPgrabCP33_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    ...
    ZE( countT , noName ) ;
    if( !POOP ) noName = etherP.diskFindFileOrDirF( tinP , pstt1FoundP , psttLikeP , pSoulP , pGrabP , csttExtraP , cMaxP ) ;
    DEL( pGrabP ) ;
    DEL( pSoulP ) ;
    etherP.delF( tinP , psttLikeP ) ;
