...
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)diskWalkCopyFileF_4P4P3_GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)diskMoveFileOrDirF_4P4P3_GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)diskMoveFileOrDirUniqueF_4P4P3_GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
...
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)diskFindFileOrDirF_4Pb4P_GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)diskFindFileOrDirF_4P4PhPgrabCP33_GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
...
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)diskMapFileNameHoverF_4P4P_GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
...
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)dllOpenF_b4P_GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
...
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)ifcIdCopyF_3_GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
...
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)openSsl_setupF__GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)openSsl_shutdownF__GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
...
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)openSsl_writeF_b1P3_GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
    ...
    _psttLeverSoixlOldApi = tNameSoixlOld ;
    if( *_pSwSoixlOldApi ) { BLAMMO ; }
    *_pSwSoixlOldApi = (countT)openSsl_readF_1P3b_GF ;
    _pSwSoixlOldApi->ungrabF( tinP ) ;
}
{
