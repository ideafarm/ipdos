...
voidT etherBeImpotentF_3_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ...
    if( !POOP ) etherP.etherBeImpotentF( tinP , codeP ) ;
}
...
voidT etherBlammoF__GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    ...
    ZE( flagsT , flagsNext ) ;
    ZE( countT , cbFieldNext ) ;
    if( !POOP ) etherP.etherBlammoF( tinP ) ;
...
voidT etherParameterF_4P_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    ...
    ZE( boolT , noName ) ;
    if( !POOP ) noName = etherP.etherParameterF( tinP , psttP ) ;
    etherP.delF( tinP , psttP ) ;
...
voidT etherScanProcessParametersF__GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    ...
    ZE( flagsT , flagsNext ) ;
    ZE( countT , cbFieldNext ) ;
    if( !POOP ) etherP.etherScanProcessParametersF( tinP ) ;
    if( tinP.fingerprint && _psttNameP && slP ) ;
}

voidT etherTestF__GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ZE( flagsT , flagsNext ) ;
    ZE( countT , cbFieldNext ) ;
    if( !POOP ) etherP.etherTestF( tinP ) ;
    if( tinP.fingerprint && _psttNameP && slP ) ;
}

voidT etherUidF_4P_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ...
    if( !POOP ) etherP.etherUidF( tinP , psttUidP ) ;
    etherP.delF( tinP , psttUidP ) ;
}

voidT ether_pstt1_processParametersI_F__GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ZE( flagsT , flagsNext ) ;
    ZE( countT , cbFieldNext ) ;
    if( !POOP ) etherP.ether_pstt1_processParametersI_F( tinP ) ;
    if( tinP.fingerprint && _psttNameP && slP ) ;
}

voidT ether_psttEarlyFolder_F__GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ZE( flagsT , flagsNext ) ;
    ZE( countT , cbFieldNext ) ;
    if( !POOP ) etherP.ether_psttEarlyFolder_F( tinP ) ;
    if( tinP.fingerprint && _psttNameP && slP ) ;
}

voidT ether_idCitizenHirerI_F__GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ZE( flagsT , flagsNext ) ;
    ZE( countT , cbFieldNext ) ;
    if( !POOP ) etherP.ether_idCitizenHirerI_F( tinP ) ;
    if( tinP.fingerprint && _psttNameP && slP ) ;
}
...
voidT etherWhereF_373_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
   ...
   SOIXLoLDtESTtYPE( 0xdddd8003 , etherC )
    ...
    if( !POOP ) etherP.etherWhereF( tinP , idActionP , flagsP , cThreadsMaxP ) ;
}
...
voidT poolNewF_331P3_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
   ...
   SOIXLoLDtESTtYPE( 0xdddd8003 , etherC )
    ...
    if( !POOP ) etherP.poolNewF( tinP , idLineNewP , idiFileNewP , pbP , cbP ) ;
...
voidT delF_1P_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    ...
    if( !POOP ) etherP.delF( tinP , pP ) ;

    if( !POOP ) slP << pP ;
    etherP.delF( tinP , pP ) ;
}

voidT delF_4P_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
...
voidT newF_331P3_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
   ...
   SOIXLoLDtESTtYPE( 0xdddd8003 , etherC )
    ...
    if( !POOP ) etherP.newF( tinP , idLineP , idiFileP , pP , cP ) ;

    if( !POOP ) slP << pP ;
    etherP.delF( tinP , pP ) ;
}

voidT newF_334P3_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
...
voidT batonGrabF_b_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
   ...
   SOIXLoLDtESTtYPE( 0xdddd8014 , etherC )
    ...
    if( !POOP ) etherP.batonGrabF( tinP , handleP ) ;
}
...
voidT batonLetGoF_b_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
   ...
   SOIXLoLDtESTtYPE( 0xdddd8014 , etherC )
    handleC handleP( /*GOOEY*/tinP , TAG( TAGiDnULL ) ) ;
    if( !POOP ) { handleP << slP ; idArgNext ++ ; }
    if( !POOP ) etherP.batonLetGoF( tinP , handleP ) ;
}
...
voidT batonOpenF_b64P_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
   ...
   SOIXLoLDtESTtYPE( 0x0 , etherC )
    ...
    if( !POOP ) etherP.batonOpenF( tinP , handleP , fCreatorP , psttP ) ;
    etherP.delF( tinP , psttP ) ;
}
    ...
    ZE( countT , hzP ) ;
    {
        ...
        if( !POOP )
        {
           idTypeNext = flagsNext = cbFieldNext = 0 ;
            ...
            if( idTypeNext == ifcIDtYPEsOULiTEM_strokeSptr && psttNext && psttNext->idAdam == 1 && psttNext[ CSpREFIX ] == sttColon )
            {
                hzP = 1760 * 4 /*4 IS BARELY AUDIBLE AND IS GOOD FOR LIBRARY*/ ;
                psttNext = 0 ;
                if( !POOP ) { slP >> psttNext ; ___( psttNext ) ; idArgNext ++ ; }
                etherP.delF( tinP , psttNext ) ;
            }
...
voidT boxGetGenerationF_1P34P4P33337_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
   ...
   SOIXLoLDtESTtYPE( 0xdddd8003 , etherC )
    ...
    if( !POOP ) etherP.boxGetGenerationF( tinP , pbP , cbP , psttP , psttLikeP , csttEstimateP , ageP , cOpenTriesP , cZapTriesP , flagsOpenDetailsP ) ;
...
voidT boxGetShadowGenerationF_1P34P4P3337_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
   ...
   SOIXLoLDtESTtYPE( 0xdddd8003 , etherC )
    ...
    if( !POOP ) etherP.boxGetShadowGenerationF( tinP , pbP , cbP , psttP , psttLikeP , csttEstimateP , ageP , cOpenTriesP , flagsOpenDetailsP ) ;
    etherP.delF( tinP , psttLikeP ) ;
...
voidT boxMailGetF_4P4P3_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
   ...
   SOIXLoLDtESTtYPE( 0xdddd8003 , etherC )
    ...
    ZE( countT , noName ) ;
    if( !POOP ) noName = etherP.boxMailGetF( tinP , psttLikeP , psttBoxIP , csttEstimateP ) ;
    etherP.delF( tinP , psttBoxIP ) ;
    etherP.delF( tinP , psttLikeP ) ;

    slP << noName ;
}

voidT boxPourF_4P4P4P33_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
   ...
   SOIXLoLDtESTtYPE( 0xdddd8003 , etherC )
    ...
    ZE( countT , noName ) ;
    if( !POOP ) noName = etherP.boxPourF( tinP , psttHostP , psttLikeToP , psttLikeFromP , csttEstimateP , cMaxP ) ;
    etherP.delF( tinP , psttLikeFromP ) ;
    etherP.delF( tinP , psttLikeToP ) ;
    etherP.delF( tinP , psttHostP ) ;

    slP << noName ;
}

voidT boxPourF_4P4P33_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
   ...
   SOIXLoLDtESTtYPE( 0xdddd8003 , etherC )
    ...
    ZE( countT , noName ) ;
    if( !POOP ) noName = etherP.boxPourF( tinP , psttLikeToP , psttLikeFromP , csttEstimateP , cMaxP ) ;
    etherP.delF( tinP , psttLikeFromP ) ;
    etherP.delF( tinP , psttLikeToP ) ;
...
voidT boxPutGenerationF_4P4P31P337_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
   ...
   SOIXLoLDtESTtYPE( 0xdddd8003 , etherC )
    ...
    if( !POOP ) etherP.boxPutGenerationF( tinP , psttP , psttLikeP , csttEstimateP , pbP , cbP , cOpenTriesP , flagsOpenDetailsP ) ;
    etherP.delF( tinP , pbP ) ;
    etherP.delF( tinP , psttLikeP ) ;
...
voidT boxPutHtmlF_64P4P4P4P4P3_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
   ...
   SOIXLoLDtESTtYPE( 0x0 , etherC )
    ...
    if( !POOP ) etherP.boxPutHtmlF( tinP , bOneFileP , psttLikeLocalP , psttLikeP , psttTitleP , psttOldCopyrightP , psttKnowledgeTreeP , cOpenTriesP ) ;
    etherP.delF( tinP , psttKnowledgeTreeP ) ;
    etherP.delF( tinP , psttOldCopyrightP ) ;
    etherP.delF( tinP , psttTitleP ) ;
    etherP.delF( tinP , psttLikeP ) ;
    etherP.delF( tinP , psttLikeLocalP ) ;
}

voidT boxPutHtmlFromKnowledgeTreeBaseF_64P4P4P4P4P33_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
   ...
   SOIXLoLDtESTtYPE( 0x0 , etherC )
    ...
    if( !POOP ) etherP.boxPutHtmlFromKnowledgeTreeBaseF( tinP , bOneFileP , psttLikeLocalP , psttLikeP , psttTitleP , psttOldCopyrightP , psttFileP , csttExtraP , cOpenTriesP ) ;
    etherP.delF( tinP , psttFileP ) ;
    etherP.delF( tinP , psttOldCopyrightP ) ;
    etherP.delF( tinP , psttTitleP ) ;
    etherP.delF( tinP , psttLikeP ) ;
...
voidT boxPutUniqueF_4P4P1P337_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ...
    if( !POOP ) etherP.boxPutUniqueF( tinP , psttP , psttLikeP , pbP , cbP , cOpenTriesP , flagsOpenDetailsP ) ;
    etherP.delF( tinP , pbP ) ;
    etherP.delF( tinP , psttLikeP ) ;
...
voidT boxServerF_36_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ...
    if( !POOP ) etherP.boxServerF( tinP , idPortP , bTalkP ) ;
}

voidT boxZapF_4P3_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ...
    if( !POOP ) etherP.boxZapF( tinP , psttP , cTriesP ) ;
    etherP.delF( tinP , psttP ) ;
}

voidT diskFileOrDirDeleteF_4P73_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ...
    if( !POOP ) etherP.diskFileOrDirDeleteF( tinP , psttP , flagsP , cTriesP ) ;
    etherP.delF( tinP , psttP ) ;
}

voidT diskFileExistsF_4P_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ...
    ZE( countT , noName ) ;
    if( !POOP ) noName = etherP.diskFileExistsF( tinP , psttLikeP ) ;
    etherP.delF( tinP , psttLikeP ) ;

    slP << noName ;
}

voidT diskWalkCopyFileF_4P4P3_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ...
    if( !POOP ) etherP.diskWalkCopyFileF( tinP , psttNewP , psttOldP , cTriesP ) ;
    etherP.delF( tinP , psttOldP ) ;
    etherP.delF( tinP , psttNewP ) ;
}

voidT diskMoveFileOrDirF_4P4P3_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ...
    if( !POOP ) etherP.diskMoveFileOrDirF( tinP , psttNewP , psttOldP , cTriesP ) ;
    etherP.delF( tinP , psttOldP ) ;
    etherP.delF( tinP , psttNewP ) ;
}

voidT diskMoveFileOrDirUniqueF_4P4P3_GF( tinS& tinP , etherC& etherP , soulC& slP , const strokeS* const _psttNameP )
{
    countT idArgNext = 1 ;
    ZE( byteT* , pbFieldNext ) ;
    ZE( countT , idTypeNext ) ;
    ...
    if( !POOP ) etherP.diskMoveFileOrDirUniqueF( tinP , psttNewP , psttOldP , cTriesP ) ;
    etherP.delF( tinP , psttOldP ) ;
